	...
	<div id="main_box">
		...
		<div id="con_box01" class="con_box">
			<div id="con_img">
				<img alt="place1" onclick="location.href='land_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/kansai/landmark/img/kansai_land1.png">
				<div id="con_name">헤이안 신궁</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box02" class="con_box">
			<div id="con_img">
				<img alt="place2" onclick="location.href='land_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/kansai/landmark/img/kansai_land2.png">
				<div id="con_name">교토 국제 만화 뮤지엄</div><img id="book" src="../../mark/markblack.png">
			</div>
		...
		<div id="con_box03" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">후시미 이나리 신사</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box04" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">만국박람회 기념공원</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box05" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">오사카 시립 주택박물관</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box06" class="con_box">
			<div id="con_img">
				<img alt="place6" onclick="location.href='land_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/kansai/landmark/img/kansai_land6.png">
				<div id="con_name">구로몬 시장</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
