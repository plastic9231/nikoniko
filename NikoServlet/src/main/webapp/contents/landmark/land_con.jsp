	...
	<main>
		<div id="conmain_img">
			<img id="main_img01" width="100%"
				src="http://localhost:9090/NikoServlet/contents/landmark/img/yufuin_main.jpg">
		...
		<div id="con_subject">
			<div id="subject_li">
				<ul>
					...
					<li><b>명소의</b> 포인트 <br> - 유후인 산 아래에 위치한 온천마을 <br> -
			...
			<section id="slideshow_sec">
				<div class="slideshow-container">
					<div class="mySlides fade">
						<img
							src="http://localhost:9090/NikoServlet/contents/landmark/img/yufu3.jpg"
							style="width: 100%">
					</div>

					<div class="mySlides fade">
						<img
							src="http://localhost:9090/NikoServlet/contents/landmark/img/yufu2.jpg"
							style="width: 100%">
					</div>

					<div class="mySlides fade">
						<img
							src="http://localhost:9090/NikoServlet/contents/landmark/img/yufu1.jpg"
							style="width: 100%">
					</div>

					<div class="mySlides fade">
						<img
							src="http://localhost:9090/NikoServlet/contents/landmark/img/yufu4.jpg"
							style="width: 100%">
					</div>
				...
				<div id="con_box01" class="con_box">
					<div id="con_img">
						<img alt="place1" onclick="location.href='land_con.jsp'"
							src="http://localhost:9090/NikoServlet/contents/landmark/img/fukutower.PNG">
				...
				<div id="con_box02" class="con_box">
					<div id="con_img">
						<img alt="place2" onclick="location.href='land_con.jsp'"
							src="http://localhost:9090/NikoServlet/contents/landmark/img/yufuin.jpg">
				...
				<div id="con_box03" class="con_box">
					<div id="con_img">
						<img alt="place3" onclick="location.href='land_con.jsp'"
							src="http://localhost:9090/NikoServlet/contents/landmark/img/sumiyoshi.PNG">
