	...
	<div id="main_box">
		...
		<div id="con_box01" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">니혼마쓰 제등 축제</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box02" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">센다이 칠석 축제</div><img id="book" src="../../mark/markblack.png">
			</div>
		...
		<div id="con_box03" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">간토 축제</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box04" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">오마가리 불꽃축제</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		...
		<div id="con_box05" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">구로이시 요사레</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
		<div id="con_box06" class="con_box">
			<div id="con_img">
				...
				<div id="con_name">사쿠라 야부사메</div><img id="book" src="../../mark/markblack.png">
			</div>
		</div>
	</div>
</body>
