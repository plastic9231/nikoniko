...
<body>
	<div id="main_box">
		...
		<div id="con_box04" class="con_box">
			<div id="con_img">
				<img alt="place4" onclick="location.href='fes_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/tohoku/festival/img/tohoku_fes4.png">
				<div id="con_name">오마가리 불꽃축제</div>
			</div>
		</div>
		...
		<div id="con_box05" class="con_box">
			<div id="con_img">
				<img alt="place1" onclick="location.href='fes_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/tohoku/festival/img/tohoku_fes5.png">
				<div id="con_name">구로이시 요사레</div>
			</div>
		</div>
		<div id="con_box06" class="con_box">
			<div id="con_img">
				<img alt="place2" onclick="location.href='fes_con.jsp'"
					src="http://localhost:9090/NikoServlet/contents/tohoku/festival/img/tohoku_fes6.png">
